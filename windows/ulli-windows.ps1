...
function Start-Installation {
    ...
    Log-Message "Disk plan approved. Strategy: $selectedStrategy, Target disk: $targetDiskNumber, Linux size: $linuxSizeGB GB"
...
"@
        ...
        # Install uefi-ntfs driver chain FIRST (before copying ISO files)
